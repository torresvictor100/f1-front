...
export default function TotalSpent(props: { [x: string]: any }) {
	...
	const [loadingDriver, setLoadingDriver] = useState(`https://www.fitapp.com.br/f1-graphics/seasons/season-drivers-ids/${selectYears}?`);
	...
	const handleButtonClick = () => {
		...
		if (nonEmptyPilots.length > 0) {
			...
			const updatedUrlSeason = `https://www.fitapp.com.br/f1-graphics/seasons/season-drivers-ids/${selectYears}?${pilotsQueryString}`;
